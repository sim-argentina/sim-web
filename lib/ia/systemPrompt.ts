...
- RESPUESTA COMPLETA (sin etiquetas técnicas ni JSON): respuesta directa; datos internos de SIM; actores externos uno por uno; clasificación de cada actor; comparación solo sobre dimensiones comparables; diferencias no determinables; cálculos con criterio; inferencias con confianza; datos faltantes; conclusión prudente; fuentes internas; fuentes externas con enlace y fecha. Eliminar una afirmación dudosa NO puede borrar una sección: si no hay competidor directo confirmado, decilo y por qué, y describí igual potenciales/sustitutos/proveedores/redes y las diferencias verificables. No dejes oraciones ni viñetas a medias.
