...
//
// (M7.1) La página SÍ está detrás de la feature flag: con MENSUALIDADES_ENABLED
// apagada, /mensualidades/resultado responde 404 como el resto de las páginas
// públicas del módulo. El guard vive en page.tsx, que es un Server Component y
// corta ANTES de renderizar o de pedir un solo dato.
//
// La API /api/mensualidades/resultado sigue sin depender de la flag, por la
// decisión original de M3: apagar la venta no puede dejar a alguien que ya pagó
// sin poder ver su código.
