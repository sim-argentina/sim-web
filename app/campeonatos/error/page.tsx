...
export default function CampeonatoErrorPage() {
  return (
    <main className="min-h-screen bg-black px-4 py-24 text-white">
      <section className="mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="text-4xl font-black md:text-6xl">Pago rechazado</h1>

        <p className="mt-5 max-w-xl text-lg leading-8 text-zinc-300">
          No pudimos confirmar el pago de tu inscripción. Puede haber sido rechazado por el
          medio de pago o cancelado durante el checkout.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-400">
                Volvé a intentar la inscripción con otro medio de pago. Si el problema continúa,
